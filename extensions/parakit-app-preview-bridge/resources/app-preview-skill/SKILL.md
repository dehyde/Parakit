---
name: app-preview
description: Use Parakit's internal App Preview tab for local web apps instead of opening external browsers or Playwright.
---
<!-- Managed by Parakit. Local edits may be overwritten when Parakit starts. -->

# App Preview

Use this skill whenever starting, previewing, testing, or visually checking a local web app in Parakit.
...
If these MCP tools are available, use them before shell/browser alternatives:
...
- `navigate_app_preview` - open a known localhost or preview URL in the pinned App Preview tab
...
3. Let Parakit route the local URL into the pinned App Preview tab.
