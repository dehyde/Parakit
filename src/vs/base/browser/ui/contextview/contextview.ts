...
const SHADOW_ROOT_CSS = /* css */ `
	...
	:host-context(.mac) { font-family: "IBM Plex Mono", monospace; }
	:host-context(.mac:lang(zh-Hans)) { font-family: "IBM Plex Mono", "PingFang SC", "Hiragino Sans GB", monospace; }
	:host-context(.mac:lang(zh-Hant)) { font-family: "IBM Plex Mono", "PingFang TC", monospace; }
	:host-context(.mac:lang(ja)) { font-family: "IBM Plex Mono", "Hiragino Kaku Gothic Pro", monospace; }
	:host-context(.mac:lang(ko)) { font-family: "IBM Plex Mono", "Apple SD Gothic Neo", "Nanum Gothic", "AppleGothic", monospace; }

	:host-context(.windows) { font-family: "IBM Plex Mono", monospace; }
	:host-context(.windows:lang(zh-Hans)) { font-family: "IBM Plex Mono", "Microsoft YaHei", monospace; }
	:host-context(.windows:lang(zh-Hant)) { font-family: "IBM Plex Mono", "Microsoft Jhenghei", monospace; }
	:host-context(.windows:lang(ja)) { font-family: "IBM Plex Mono", "Yu Gothic UI", "Meiryo UI", monospace; }
	:host-context(.windows:lang(ko)) { font-family: "IBM Plex Mono", "Malgun Gothic", "Dotom", monospace; }

	:host-context(.linux) { font-family: "IBM Plex Mono", monospace; }
	:host-context(.linux:lang(zh-Hans)) { font-family: "IBM Plex Mono", "Source Han Sans SC", "Source Han Sans CN", "Source Han Sans", monospace; }
	:host-context(.linux:lang(zh-Hant)) { font-family: "IBM Plex Mono", "Source Han Sans TC", "Source Han Sans TW", "Source Han Sans", monospace; }
	:host-context(.linux:lang(ja)) { font-family: "IBM Plex Mono", "Source Han Sans J", "Source Han Sans JP", "Source Han Sans", monospace; }
	:host-context(.linux:lang(ko)) { font-family: "IBM Plex Mono", "Source Han Sans K", "Source Han Sans JR", "Source Han Sans", "UnDotum", "FBaekmuk Gulim", monospace; }
`;
