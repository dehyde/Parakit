...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Parakit in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Parakit and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
