...
const CONFIGURE_APP_PREVIEW_URL_COMMAND_ID = 'workbench.action.agentSessions.configureAppPreviewUrl';
...
export class BrowserEditorInput extends EditorInput {
	...
	private _tabAction: IAction | undefined;
	...
	override getTabAction(): IAction | undefined {
		if (!this.isSessionAppPreview) {
			return undefined;
		}
