	...
	properties: {
		...
		[mcpAccessConfig]: {
			...
			enumDescriptions: [
				...
				nls.localize('chat.mcp.access.registry', "Allows access to MCP servers installed from the registry that Parakit is connected to."),
			...
			policy: {
				...
				localization: {
					...
					enumDescriptions: [
						...
						{
							key: 'chat.mcp.access.registry', value: nls.localize('chat.mcp.access.registry', "Allows access to MCP servers installed from the registry that Parakit is connected to."),
						},
						{
		...
		[ChatConfiguration.ExtraMarketplaces]: {
			...
			// JSON Schema's `type` keyword (equivalent to `type: 'string'`) to trigger Parakit's
		...
		[ChatConfiguration.AgentHostClientTools]: {
			...
			default: [
				...
				'run_preview_server', 'get_preview_status', 'restart_preview_server', 'promote_preview_url',
