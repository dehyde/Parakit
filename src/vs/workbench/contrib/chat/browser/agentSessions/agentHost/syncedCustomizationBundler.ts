...
const DISPLAY_NAME = 'Parakit Synced Data';

const MANIFEST_CONTENT = JSON.stringify({
	name: DISPLAY_NAME,
	description: 'Customization data synced from Parakit',
}, null, '\t');
...
/**
 * An MCP server configured directly in Parakit (i.e. not contributed by an
 ...
 * ```
 * .plugin/plugin.json
 * .mcp.json        ← MCP servers configured in Parakit
