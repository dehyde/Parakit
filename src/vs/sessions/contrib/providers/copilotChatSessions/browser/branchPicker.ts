...
import { getStableActionWidgetAnchor, IActionWidgetService } from '../../../../../platform/actionWidget/browser/actionWidget.js';
...
export class BranchPicker extends Disposable {
	...
	showPicker(): void {
		...
		this.actionWidgetService.show<IBranchItem>(
			...
			items,
			delegate,
			getStableActionWidgetAnchor(this._triggerElement),
			undefined,
			[],
			{
