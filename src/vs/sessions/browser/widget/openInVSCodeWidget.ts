...
/**
 * Renders the "Open in Parakit" titlebar entry as an icon-only button that
...
export class OpenInVSCodeTitleBarWidget extends BaseActionViewItem {
	...
	override render(container: HTMLElement): void {
		...
		const hoverText = this.keybindingService.appendKeybinding(localize('openInVSCodeHover', "Open in Parakit Editor Window"), this.keybindingCommandId);
