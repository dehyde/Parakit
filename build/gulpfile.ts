...
const compileClientTask = task.define('compile-client', task.series(
	...
	task.define('esbuild-out', () => runEsbuildTranspile('out', false)),
	task.define('typecheck-client-tsgo', () => spawnTsgo(path.join(root, 'src', 'tsconfig.json'), { taskName: 'typechecking client (tsgo)', noEmit: true }))
));
